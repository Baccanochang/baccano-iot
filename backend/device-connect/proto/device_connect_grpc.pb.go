...
func NewDeviceConnectClient(cc grpc.ClientConnInterface) DeviceConnectClient { return &deviceConnectClient{cc} }
...
func (UnimplementedDeviceConnectServer) Authenticate(context.Context, *AuthRequest) (*AuthResponse, error) { return nil, grpc.ErrServerStopped }
func (UnimplementedDeviceConnectServer) PublishTelemetry(context.Context, *Telemetry) (*TelemetryAck, error) { return nil, grpc.ErrServerStopped }
...
func _DeviceConnect_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
    ...
    if interceptor == nil { return srv.(DeviceConnectServer).Authenticate(ctx, in) }
    info := &grpc.UnaryServerInfo{Server: srv, FullMethod: "/deviceconnect.DeviceConnect/Authenticate"}
    handler := func(ctx context.Context, req interface{}) (interface{}, error) { return srv.(DeviceConnectServer).Authenticate(ctx, req.(*AuthRequest)) }
...
func _DeviceConnect_PublishTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
    in := new(Telemetry)
    if err := dec(in); err != nil { return nil, err }
    if interceptor == nil { return srv.(DeviceConnectServer).PublishTelemetry(ctx, in) }
    info := &grpc.UnaryServerInfo{Server: srv, FullMethod: "/deviceconnect.DeviceConnect/PublishTelemetry"}
    handler := func(ctx context.Context, req interface{}) (interface{}, error) { return srv.(DeviceConnectServer).PublishTelemetry(ctx, req.(*Telemetry)) }
    return interceptor(ctx, in, info, handler)
}
