...
func (s *DeviceService) UpdateDesired(id string, desired map[string]interface{}) (domain.Shadow, bool) {
	return s.repo.UpdateDesired(id, desired)
}
func (s *DeviceService) GetAttributes(id string) (map[string]interface{}, bool) {
	return s.repo.GetAttributes(id)
}
func (s *DeviceService) UpdateAttributes(id string, attrs map[string]interface{}) (map[string]interface{}, bool) {
	return s.repo.UpdateAttributes(id, attrs)
}
